...
parser.add_argument('--jsonl',type=str,default="/lustre/gst/xuchunfu/zhangxt/data/validation_set.jsonl", help="weight_decay")
...
def group_texts(examples, block_size=40000):
...
# block_size = 38
train_dataset = train_dataset.map(group_texts, batched=True, num_proc=400)
...
wandb.init( project=args.project_name, name=args.run_name, config={"lr":args.lr,
        "epoch":args.epoch,
